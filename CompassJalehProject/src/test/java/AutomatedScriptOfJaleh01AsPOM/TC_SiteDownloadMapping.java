...
public class TC_SiteDownloadMapping extends BaseTest2 {
	...
	public static void FeatureWithorWithoutPrice(String sitename,String productname,String adminRole,String priceOption ) throws Exception {
		...
		clcikDownloadsitemapping(adminRole,priceOption);
	...
	/*
	 * public static void validationPriceOrWithoutPriceOnSiteDownloadMapping() {
	 * 
	...
	public static void clcikDownloadsitemapping(String adminRole, String priceOption) throws Exception {
