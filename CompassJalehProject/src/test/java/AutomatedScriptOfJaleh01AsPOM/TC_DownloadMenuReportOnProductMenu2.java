...
public class TC_DownloadMenuReportOnProductMenu2 extends BaseTest2 {
...
//			data[i][6] = row.get("MenuCategory");
			data[i][5] = row.get("ReportStartDate").trim();
			data[i][6] = row.get("ReportEndDate").trim();
		}

		return data;
	}
	@Test(dataProvider = "recipeDataProvider")
	public void Test_TemplateMenu(String username, String password, String sitename,String productname,String priceOption,String ReportStartDate,String ReportEndDate) throws Throwable {
		// setup();
		loginToApplication(username, password);
		menureport(sitename,productname,priceOption,ReportStartDate,ReportEndDate);
		// tearDown();
		// recipedisplayname,mealtype,cuisine,recipecategory
	}
	
	
	public static void menureport(String sitename ,String productname,String priceOption,String ReportStartDate,String ReportEndDate) throws Exception {
