...
public class SC01_RefreshRecipe2 extends BaseTest2 {

    @DataProvider(name = "recipeDataProvider")
    public Object[][] recipeDataProvider() throws IOException {
        List<Map<String, String>> dataList = readData("E:\\Automation Testing data\\Jaleh\\test1_creation_Master.xlsx", "SC_Refresh Recipe");
    ...
    public static void refreshRecipe(String menuname, String sitename2, String sitename1, String Recipename) {
        try {
	        ...
	        System.out.println("Popup after updating recipe: " + msg);
	        testLogger.info(msg);
