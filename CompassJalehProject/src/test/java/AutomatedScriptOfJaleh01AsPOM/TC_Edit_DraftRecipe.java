...
public class TC_Edit_DraftRecipe extends BaseTest2 {
	@DataProvider(name = "recipeDataProvider") // ✅ Rename here

	public Object[][] recipeDataProvider() throws IOException {
	    List<Map<String, String>> dataList = readData("E:\\Automation Testing data\\Jaleh\\test1_creation_Master.xlsx", "TC_Edit Draft Recipe");
	...
	public void editRecipe(String rcpname,String recipedisplayname,String mealtype,String cuisine,String recipecategory ) throws Throwable {
		clickHome();
		clickRecipeMain();
		...
		testLogger.info("<span style='color:green; font-weight:bold;'>" + oldMealType + "</span>"	 + " meal type changed to " + "<span style='color:blue; font-weight:bold;'>" + mealtype + "</span>"	);
	...
	//"<span style='color:blue; font-weight:bold;'>" + mealtype + "</span>"	
		...
		testLogger.info("<span style='color:green; font-weight:bold;'>" + oldcuisine + "</span>"	 + " cuisine changed to " + "<span style='color:blue; font-weight:bold;'>" + cuisine + "</span>"	);
		...
		//testLogger.info(oldrecipecategory + " meal type changed to " + recipecategory);
		testLogger.info("<span style='color:green; font-weight:bold;'>" + oldrecipecategory + "</span>"	 + " recipecategory changed to " + "<span style='color:blue; font-weight:bold;'>" + recipecategory + "</span>"	);
		...
		//testLogger.info(oldcategory +" meal type chnged to " + recipecategory );
		clickPublishDraft();
       ...
       // driver.findElement(By.xpath("//i[@class='nav-icon fa-brands fa-firstdraft']")).click(); 
		...
		//String  oldMealType = driver.findElement(By.xpath("(//label[contains(text(),'Meal Type')]/following-sibling::span//span[last()]//span)[1]")).getText();
		
		public String getOldMealType() {
		    try {
		        WebElement oldMealTypeElement = driver.findElement(By.xpath("(//label[contains(text(),'Meal Type')]/following-sibling::span//span[last()]//span)[1]"));
...
//        ExtentTest testLogger= myListener3.getTest();
//		
//		testLogger.info(oldMealType +" meal type chnged to " + mealtype );
//		
		
		
		

		//String  oldcuisine = driver.findElement(By.xpath("((//label[contains(text(),'Cuisine')]/following-sibling::span//span[last()]//span)[1]")).getText();

		public String getoldcuisine() {
		    try {
		        WebElement oldcuisineElement = driver.findElement(By.xpath("(//label[contains(text(),'Cuisine')]/following-sibling::span//span[last()]//span)[1]"));
		...
		//String  oldcategory = driver.findElement(By.xpath("(//label[contains(text(),'Recipe Category')]/following-sibling::span//span[last()]//span)[1]")).getText();

		
		public String getoldRecipeCategory() {
		    try {
		        WebElement oldRecipeCategoryElement = driver.findElement(By.xpath("(//label[contains(text(),'Recipe Category')]/following-sibling::span//span[last()]//span)[1]"));
