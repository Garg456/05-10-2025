...
public class TC_ReportsNewOrUnpublishedMenu extends BaseTest2 {
	...
	public void Test_TemplateMenu(String username, String password, String sitename,String productname,String adminrole,String priceOption,String Report_Type,String menu_Type,String ReportStartDate,String ReportEndDate) throws Throwable {
		// setup();
		loginToApplication(username, password);
		menureport(sitename,productname,adminrole,priceOption,Report_Type,menu_Type , ReportStartDate,ReportEndDate);
		// tearDown();
		// recipedisplayname,mealtype,cuisine,recipecategory
	}
	
	
	public static void menureport(String sitename ,String productname,String adminrole,String priceOption ,String Report_Type,String menu_Type,String ReportStartDate,String ReportEndDate) throws Exception {
