...
public class TC_CreateTemplateMenu extends BaseTest2 {
	...
	public void Test_TemplateMenu(String username, String password, String recipeName, String menuname, String sitename,
	    ...
	    // Override recipeName if TC01 created recipe exists
	...
	public static void TemplateMenu(String menuname, String sitename, String Recipename, String Menu_Type,
		...
		/*
		 * clickHome(); clickMenus(); clickTemplateMenus(); SearchRecipeBeforeCreation
		 * srbc = new SearchRecipeBeforeCreation(); srbc.searchProduct(menuname);
		 */
		clickHome();
		clickMenus();
		//clickTemplateMenus();
		...
		/*
		 * clickHome(); clickMenus(); clickTemplateMenus(); SearchRecipeAfterCreation
		 * srac = new SearchRecipeAfterCreation(); //searchMenu sm =new searchMenu();
		 * //sm.searchProduct(menuname);
		 * 
