...
public class SC001_RefreshRecipe extends BaseTest {
	String menuname = "MenuA19H";
	...
	String Recipename="Rec98TY";
			
	
	@Test(dataProvider = "loginData")
	public void Test_refreshRecipe(String username, String password, String recipeName, String productDescription,
			String ingredientGroup,String recipedisplayname,String mealtype,String cuisine,String recipecategory,String publishType) throws Throwable {
		//setup();
...
//			        driver.findElement(By.xpath("//a[text()='Publish']")).click();
		...
		public static void editandPublishRecipe() throws Exception { 
